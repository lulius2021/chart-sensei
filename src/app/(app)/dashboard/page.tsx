  ...
  return (
    <div className="p-8 lg:p-10 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-neutral-500 text-sm">Here&apos;s your trading education progress</p>
      </div>
        ...
        {stats.map((s) => (
          <div key={s.label} className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs text-neutral-600 uppercase tracking-wide">{s.label}</span>
            </div>
            <div className="text-2xl font-bold text-white">{s.value}</div>
            <div className="text-xs text-neutral-700 mt-1">{s.sub}</div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="/analyze" className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-6 hover:border-brand/30 transition group">
          <div className="text-2xl mb-3">📊</div>
          <h3 className="text-sm font-semibold text-white mb-1 group-hover:text-brand transition">Analyze Your First Chart</h3>
          <p className="text-xs text-neutral-500">Upload a screenshot or use live charts to get AI analysis</p>
        </a>
        <a href="/learn" className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-6 hover:border-brand/30 transition group">
          <div className="text-2xl mb-3">📚</div>
          <h3 className="text-sm font-semibold text-white mb-1 group-hover:text-brand transition">Learn a Strategy</h3>
          <p className="text-xs text-neutral-500">Start with Support & Resistance — the foundation of all trading</p>
        </a>
        <a href="/quiz" className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-6 hover:border-brand/30 transition group">
          <div className="text-2xl mb-3">🧠</div>
          <h3 className="text-sm font-semibold text-white mb-1 group-hover:text-brand transition">Test Your Knowledge</h3>
          <p className="text-xs text-neutral-500">Take a quiz to see how well you can read chart patterns</p>
        </a>
      </div>
    </div>
  );
