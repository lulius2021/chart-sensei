  ...
  return (
    <div className="p-8 lg:p-10">
      <div className="mb-8">
        ...
        <p className="text-text-muted text-sm">Real-time charts powered by TradingView</p>
      </div>
      <div className="bg-surface-2 border border-surface-4 rounded-2xl overflow-hidden" style={{ height: "calc(100vh - 180px)" }}>
        <iframe
