      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface-2 border border-surface-4 rounded-2xl p-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-surface-3 border border-surface-4 text-white py-3 rounded-xl text-sm font-medium hover:border-text-dim transition mb-4"
          >
          ...
          {error && (
            <div className="bg-loss/10 border border-loss/20 text-loss text-xs rounded-lg px-3 py-2 mb-4">
              {error}
            </div>
          )}
          {message && (
            <div className="bg-brand-muted border border-brand/20 text-brand text-xs rounded-lg px-3 py-2 mb-4">
              {message}
            </div>
          )}
